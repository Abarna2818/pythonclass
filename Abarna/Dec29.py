...
from tkinter import *
root=Tk()
frame=Frame(root,bg="Green",width=600,height=600)
frame.pack()
root.mainloop()
...
from tkinter import messagebox
top=tkinter.Tk()
frame=tkinter.Frame(top,bg="purple",height=500,width=500)
def search():
    messagebox.showinfo("Hi Everyone","How are you")
b=tkinter.Button(top,text="Hi",command=search)
B=tkinter.Button(top,text="Hi",activebackground="pink")
b.pack()
frame.pack()
top.mainloop()
'''
...
f1=tkinter.Frame(t)
f2=tkinter.Frame(t)
l=tkinter.Label(f1,text="Hi friends")
l.pack()
b=tkinter.Button(f2,text="Whatsup")
b.pack()
f1.pack(padx=10,pady=20)
f2.pack(padx=25,pady=50)
t.mainloop() '''
